...
Notes:
- Do NOT commit your keys to git. Keep `.env.local` private.
- If you enable email confirmations in Supabase, users will need to confirm their email before signing in.
